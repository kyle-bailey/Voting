class BallotController < ApplicationController
	...
	def create_races
		...
		if @ballot.theme == "political" and @ballot.organization == "s_exp"
			...
			#president/vice
			@race = @ballot.races.create(category:"President and Vice President", race_type:"Choose One", title:"President and Vice President", ballot_id: @ballot.id, voted: false);
			...
			@race.candidate.create(name: "No Preference", race_id: @race.id, selected: false)
		...
		elsif @ballot.theme == "rice" and @ballot.organization == "s_exp"

			#easiest distro
			@race = @ballot.races.create(race_type:"Choose One", title:"Hardest Double-major at Rice", ballot_id: @ballot.id, voted: false);
